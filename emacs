...
(custom-set-variables
 ...
 '(gnus-group-line-format "%5y %(%-70,70g%)
" t)
 '(gnus-posting-styles
   (quote
    (((header "to" "ryanartecona@gmail\\.com")
      (address "ryanartecona@gmail.com"))
     ((header "to" "ryan@wistia.com")
      (address "ryan@wistia.com")))))
 ...
 '(gnus-secondary-select-methods
   (quote
    ((nnimap "gmail-wistia"
             ...
             (nnmail-expiry-target "nnimap+gmail-wistia:[Gmail]/Trash"))
     (nnimap "gmail-home"
             (nnimap-address "imap.gmail.com")
             (nnimap-server-port 993)
             (nnimap-stream ssl)
             (nnir-search-engine imap)
             (nnmail-expiry-target "nnimap+gmail-home:[Gmail]/Trash")))))
 '(gnus-select-method (quote (nnnil "")))
 '(gnus-summary-line-format "%U%R%z %(%&user-date;  %-30,30f %e %B %s%)
")
